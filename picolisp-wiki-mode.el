...
;; prefix changed from "\C-c" to "\C-l" due to conflicts with outline&outshine
(defvar picolisp-wiki-mode-map
  (let ((map (make-keymap)))
    ;; Element insertion
    (define-key map "\C-l\C-ln" 'picolisp-wiki-insert-internal-link)
    (define-key map "\C-l\C-lx" 'picolisp-wiki-insert-external-link)
    (define-key map "\C-l\C-lu" 'picolisp-wiki-insert-unordered-list)
    (define-key map "\C-l\C-lo" 'picolisp-wiki-insert-ordered-list)
    (define-key map "\C-l\C-li" 'picolisp-wiki-insert-list-item)
    (define-key map "\C-ll" 'picolisp-wiki-insert-left-floating-content)
    (define-key map "\C-ln" 'picolisp-wiki-insert-non-floating-content)
    (define-key map "\C-lr" 'picolisp-wiki-insert-right-floating-content)
    (define-key map "\C-lk" 'picolisp-wiki-insert-line-breaks)
    (define-key map "\C-l1" 'picolisp-wiki-insert-header-1)
    (define-key map "\C-l2" 'picolisp-wiki-insert-header-2)
    (define-key map "\C-l3" 'picolisp-wiki-insert-header-3)
    (define-key map "\C-l4" 'picolisp-wiki-insert-header-4)
    (define-key map "\C-l5" 'picolisp-wiki-insert-header-5)
    (define-key map "\C-l6" 'picolisp-wiki-insert-header-6)
    (define-key map "\C-lb" 'picolisp-wiki-insert-bold)
    (define-key map "\C-li" 'picolisp-wiki-insert-italic)
    (define-key map "\C-lu" 'picolisp-wiki-insert-underlined)
    (define-key map "\C-lp" 'picolisp-wiki-insert-pre-block)
    (define-key map "\C-lc" 'picolisp-wiki-insert-comment)
    (define-key map "\C-l-" 'picolisp-wiki-insert-hr)
